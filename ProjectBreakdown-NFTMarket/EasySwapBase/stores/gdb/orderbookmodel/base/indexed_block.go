...
type IndexedStatus struct {
	...
	LastIndexedBlock int64 `json:"last_indexed_block" gorm:"column:last_indexed_block;NULL)"`                               //最后一次同步的区块高度
	LastIndexedTime  int64 `json:"last_indexed_time" gorm:"column:last_indexed_time;NULL)"`                                 //最后一次同步的时间
	IndexType        int32 `json:"index_type" gorm:"column:index_type;type:tinyint(4);not null;default:0"`                  //0:activity 1:trade info 6:事件
